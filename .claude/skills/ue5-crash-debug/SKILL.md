...
Read the callstack or log output. Identify which category fits. Read the spoke file for UE5-specific causes Claude wouldn't know by default. Fix the root cause, not the symptom.

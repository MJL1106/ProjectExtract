...
public:
	...
	bool Build(FCoverMemory* Memory, UWorld* World, const ARecastNavMesh* NavMesh, const FCoverBuildParams& Params, const TArray<FCoverData>& PostBuildWriteData, TFunctionRef<void()> EvalThreadSleepFunc);

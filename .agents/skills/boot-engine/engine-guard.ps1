<#
  ...
  Separate Codex/Claude chats are separate processes; the only thing they share is the
  filesystem. This script uses a single shared lock file (.claude/engine-session.lock.json) as a

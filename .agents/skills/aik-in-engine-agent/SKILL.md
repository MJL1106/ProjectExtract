...
The CLI-targeted sections of `AGENTS.md` reference: `ue5-cpp-implementer`, `ue5-safety-reviewer`, `ue5-performance-reviewer`, `agent-teams:team-spawn`, `Bash`, custom skills like `ue5-class-scaffold`, etc. **None of these exist in your environment.** Skip them. Your reference is this skill file.
